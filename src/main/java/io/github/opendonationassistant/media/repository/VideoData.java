...
public record VideoData(
  ...
  @Nullable
  @Schema(description = "Recipient ID associated with this video")
  String recipientId,
  @Nullable
  @Schema(description = "Timestamp when video is ready")
  Instant readyTimestamp,
  @Nullable
  @Schema(description = "Payment ID associated with this video")
  String paymentId,
  String system
)
